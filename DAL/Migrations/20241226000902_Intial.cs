        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LasttName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbStudentSubjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TbStudentSubjects_TbStudents_StudentId",
                        column: x => x.StudentId,
                        principalTable: "TbStudents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TbStudentSubjects_TbSubjects_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TbStudentSubjects_StudentId",
                table: "TbStudentSubjects",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_TbStudentSubjects_SubjectId",
                table: "TbStudentSubjects",
                column: "SubjectId");
        }
