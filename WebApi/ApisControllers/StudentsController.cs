...
namespace WebApi.ApisControllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        public ApiResponse GetAll()
        {
            ...
            try
            {
                oApiResponse.Data = _studentService.GetAll();
        ...
        [HttpPost("Add")]
        public ApiResponse Add([FromBody] StudentDto modelDto)
        {
            ApiResponse oApiResponse = new ApiResponse();
        ...
        [HttpPost("Edit")]
        public ApiResponse Edit([FromBody] StudentDto modelDto)
        {
            ApiResponse oApiResponse = new ApiResponse();
            ...
            try
            {
                ...
                var student = _studentService.GetById(modelDto.Id);
                if (student == null)
                {
        ...
        public ApiResponse Delete([FromBody] Guid id)
        {
            ...
            {
                ApiResponse oApiResponse = new ApiResponse();
                if (_studentService.ChangeStatus(id, 0))
                {
